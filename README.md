...
![screenshot](assymetric/3.jpg)

![screenshot](assymetric/3.0.jpg)

![screenshot](assymetric/3.1.jpg)
...
![screenshot](assymetric/4.jpg)

![screenshot](assymetric/4.0.jpg)

4. Модифицируйте код FTP-сервера таким образом, чтобы он поддерживал шифрование.

![screenshot](assymetric/6.jpg)
